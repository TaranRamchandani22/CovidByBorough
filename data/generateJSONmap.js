...
//let arrayZipData = [];
let peeps_csv = fs.readFileSync(__dirname+'/totalData.csv', 'utf8');
...
//neighborhood_info[1]+"={"+neighborhood+"}"
fs.writeFileSync('totalDataMap.json', JSON.stringify(neighborhoods), 'utf8');//we shoulf puy yhid in the data file
